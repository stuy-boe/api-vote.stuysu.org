...
describe('errorHandler', () => {
  ...
  const refusedError =
      new RequestRefusalError('Request was refused.', 'REQUEST_REFUSED');
  ...
  before(() => {
    ...
    app.get('/throwRefusal', (req, res) => { throw refusedError; });
    ...
    app.get('/throwUnexpected', (req, res) => { throw unexpectedError; });
  ...
  describe('Catching Request Refusal Errors', () => {
    const refusedRequestTest = endpoint => done => {
      request(app).get(endpoint).then(res => {
        ...
        expect(res.body.error.message).to.equal('Request was refused.');

        done();
      });
    };

    it('should catch synchronous Request Refusal Errors',
       refusedRequestTest('/throwRefusal'));

    it('should catch asynchronous Request Refusal Errors',
  ...
  describe('Catching Unexpected Server Errors', () => {
    ...
    it('should catch synchronous unexpected errors',
       unexpectedErrorTest('/throwUnexpected'));

    it('should catch asynchronous unexpected errors',
