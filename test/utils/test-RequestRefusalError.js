...
describe('RequestRefusalError', () => {
  const RequestRefusalErrorInstance =
      new RequestRefusalError('Test Message', 'ERROR_CODE');
  ...
  it('should have a message property', done => {
    expect(RequestRefusalErrorInstance)
        .to.have.property('message', 'Test Message');

    done();
  });

  it('should have an error code property', done => {
    expect(RequestRefusalErrorInstance).to.have.property('code', 'ERROR_CODE');
  ...
  it('should have the name: Request Refusal', done => {
    expect(RequestRefusalErrorInstance)
        .to.have.property('name', 'Request Refusal');
