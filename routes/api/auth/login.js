...
router.use('/', async (req, res) => {
  ...
  try {
    ...
    throw new RequestRefusalError('The provided login token was invalid.',
                                  'INVALID_ID_TOKEN');
  }

  if (req.session.signedIn) {
    throw new RequestRefusalError('You are already signed in.', 'SIGNED_IN');
  }
  ...
  req.session.encryptedUserId =
      encryptString(payload.sub, encryptKey, encryptIv);
