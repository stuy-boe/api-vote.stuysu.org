 ...
 * @param  {Buffer} key - The secret phrase used to encrypt the string (Must be 32 bytes)
 * @param {Buffer} iv - A random salt used to prevent data repetition (Must be 16 bytes)
